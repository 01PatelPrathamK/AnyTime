...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    ...
    <div className="flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden">
      <img src={"/app-icon.svg"} className="max-w-16" alt="" />
      <p className="text-lg font-medium text-white font-mono">
        Chat anytime at anywhere on{" "}
        <span className="font-sans font-extrabold tracking-tight text-sky-400 drop-shadow-[0_0_12px_rgba(56,189,248,0.8)] text-3xl">
          "AnyTime"
        </span>
      </p>
    </div>
